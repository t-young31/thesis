...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			Use the function to generate a transition state guess geometry as in the first instance the saddle point in the 2D surface.
...
\begin{figure}[h!]
	\vspace{0.4cm}
	\centering
	\includegraphics[width=14cm]{5/autode/figs/figS14.pdf}
	\vspace{0.4cm}
	\hrule
