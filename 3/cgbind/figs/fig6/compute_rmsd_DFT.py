from cgbind import Linker, Cage, Config, ORCA
...
if __name__ == '__main__':
    ...
    for struct in data.structs:
        ...
        if True:
            ...
            if basename == 'OVUSIJ_edit':
                # RDkit fails to generate the correct conformer,,,
                linker = Linker(arch_name=struct.arch, xyzs=xyzfile2xyzs('ome_linker.xyz'))

            elif basename == 'RIJGUM_edit':
            ...
            cage.optimise(method=ORCA, keywords=['LooseOpt', 'PBE', 'RI', 'D3BJ', 'def2-SVP', 'def2/J'], n_cores=8)
